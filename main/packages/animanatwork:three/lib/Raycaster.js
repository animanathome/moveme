...
( function ( THREE ) {
	...
	var intersectObject = function ( object, raycaster, intersects ) {
		// console.log('Raycaster: intersectObject', object.name)
		...
		if ( object instanceof THREE.Particle ) {
			...
			if ( object.boundingBox !== null && object.visible === true) 
			{
				...
				// console.log('\t\t\t', 'local ray', localRay)
				...
				//	old
				// if ( localRay.isIntersectionBox( object.boundingBox ) === true )  
				// {
				// 	// console.log('\t\t\tis intersecting', object.name)
				// 	// console.log('\t\t\t', object.boundingBox)
				// 	// console.log('\t\t\t', 'local ray', localRay)
				...
				if( object.hasDisplay() === true ){
					// console.log('\tcontrol display')

					var precision = raycaster.linePrecision;
					var precisionSq = precision * precision;

					var geometry = object.cd.geometry;
					...
					var step = 1;//object.type === THREE.LineStrip ? 1 : 2;
